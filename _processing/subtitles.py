...
def generate_image_ass(raw_latex, match_counter):
    png_path = path + str(match_counter) + ".png"
...
# replace path the your project as appropriate
path_to_media = "../_template/media/"

# replace file names as appropriate
convert_srt_to_ass(path + "videos/main/1080p60/Template.srt", path + "temp.ass")
process_latex_from_ass(path + "temp.ass", path + "Template.ass")
os.remove(path + 'temp.ass')